      ...
      <div class="form-container">
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <svg class="input-icon" fill="none" height="20" stroke="currentColor" stroke-width="2"
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            >
              <svg v-if="!showPassword" fill="none" height="20" stroke="currentColor" stroke-width="2"
                   viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                <circle cx="12" cy="12" r="3"></circle>
              </svg>
              <svg v-else fill="none" height="20" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
        ...
        <button :disabled="isLoading" class="login-btn" @click="login">
